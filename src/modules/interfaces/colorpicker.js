...
class ColorPicker {
    constructor() {
        this.parent = document.getElementById('input-color-picker');
        this.wheel = document.getElementById('input-color-picker-wheel');
        this.selected = document.getElementById('input-color-picker-selected');
        this.inputHex = document.getElementById('input-color-picker-hex');
        this.inputRGB = document.getElementById('input-color-picker-rgb');
        this.buttons = document.getElementById('input-color-picker-buttons');
    ...
    init() {
        ...
        this.selected.children[1].onclick = () => {
            this.colorWheel.hex = this.current;
        };
